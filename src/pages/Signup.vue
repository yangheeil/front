<template>
  <q-page class="text-center flex flex-center q-pa-xl">
    <div style="max-width: 1023px" class="q-gutter-y-md column">
      ...
      <div class="text-subtilte1">
        WithJK는 오징어 꼴뚜기 대구명태 거북이 입니다.
      </div>
      <div class="line">SNS 회원가입</div>
      <div class="row q-gutter-x-md">
        <q-btn class="col q-py-sm q-px-sm target"
          ><img src="~assets/google-svg.svg" style="width: 24px"
        /></q-btn>
        <q-btn class="col q-py-sm q-px-sm target"
          ><img src="~assets/naver-svg.svg" style="width: 24px"
        /></q-btn>
        <q-btn class="col q-py-sm q-px-sm target"
          ><img src="~assets/kakaotalk-svg.svg" style="width: 24px"
        /></q-btn>
      </div>
